...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelProductName.Text = "Video Bonanza"
        ...
        Me.LabelCompanyName.Text = "Matt Kline"
        ...
        Me.TextBoxDescription.Text = "Description :This program will take input of DVD and VHS purchases and keep a tot" & _
    "al of the purchase until checkout. Then will calculate the total and display tot" & _
    "al due"
        '
        'OKButton
        '
