...
Public Class VideoBonanza
    ...
    Private Sub CalculateButton_Click(sender As Object, e As EventArgs) Handles CalculateButton.Click
        ...
        'Check type of movie
        If DVDRadioButton.Checked And NewReleaseCheckBox.Checked Then
            PriceDecimal = DVD_NEW_PRICE_Decimal
        ElseIf DVDRadioButton.Checked Then
            PriceDecimal = DVD_OLD_PRICE_Decimal
        ElseIf VHSRadioButton.Checked And NewReleaseCheckBox.Checked Then
        ...
        If MemberCheckBox.Checked Then
            MemberDiscountDecimal = (MEMBER_DISCOUNT_Decmial * PriceDecimal)
        End If
