...
Partial Class SalesCalculator
    ...
    Private Sub InitializeComponent()
        ...
        Me.PayTotalTextbox.TabIndex = 10
        '
        ...
        Me.CommissionTotalTextbox.TabIndex = 9
        '
        'SalesTotalTextbox
        '
        ...
        Me.SalesTotalTextbox.TabIndex = 8
        '
        'SalesCalculator
        '
